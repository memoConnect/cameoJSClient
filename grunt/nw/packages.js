module.exports = function(grunt, options){
    ...
    grunt.registerTask('nw:packages', [
        'clean:nw-packages',
        'concat:nw-vendor',
        'concat:nw-desktop-packages',
        'concat:nw-desktop-cameo'
    ]);
    ...
    var concatCreateCmPackages = function (packagesObject) {
        ...
        Object.keys(packagesObject).forEach(function (packageName) {
            ...
            packages['build/nodeWebkit/packages/' + packageName + '.js'] = [
        ...
        tasks:{
            ...
            concat: {
                ...
                'nw-vendor': {
                    ...
                    dest: 'dist/nodeWebkit/vendor.' + options.globalCameoBuildConfig.config.version + '.js'
                },
                'nw-desktop-packages': {
                    options: {
                        banner: "'use strict';\n\n",
                ...
                'nw-desktop-cameo': {
                    ...
                    src: [
                        'build/nodeWebkit/base/config.js',
                        'desktop/base/app.js',
                        'build/nodeWebkit/packages/*.js'
                    ],
                    dest: 'dist/nodeWebkit/cameo.' + options.globalCameoBuildConfig.config.version + '.js'
                }
            }
        }
    }
